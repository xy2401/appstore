...
- [遮挡壁纸 - 可遮挡锁屏管理文字壁纸](#遮挡壁纸_-_可遮挡锁屏管理文字壁纸)
- [Procreate Pocket](#procreate_pocket)
- [古诗文网-唐诗宋词古文典籍](#古诗文网-唐诗宋词古文典籍)
...
- [ClashX Pro - Server Manager](#clashx_pro_-_server_manager)
- [iGuzheng](#iguzheng)
- [List背单词](#list背单词)
...
- [我爱截图 - 微商营销做图工具](#我爱截图_-_微商营销做图工具)
- [D2 Pal Pro for Diablo2](#d2_pal_pro_for_diablo2)
- [怦然心动的瞬间-轻科幻真人互动恋爱影游](#怦然心动的瞬间-轻科幻真人互动恋爱影游)
- [女帝的日常](#女帝的日常)
- [西语背单词](#西语背单词)
- [nPlayer](#nplayer)
- [DotInk](#dotink)
- [ProMovie Recorder +](#promovie_recorder__)
- [CNC Lathe calculator](#cnc_lathe_calculator)
- [雨时](#雨时)
- [Plant a Day](#plant_a_day)
- [Human Anatomy Atlas 2026](#human_anatomy_atlas_2026)
- [JPics](#jpics)
- [Tampermonkey](#tampermonkey)
- [Camera360 Concept - HelloCamera](#camera360_concept_-_hellocamera)
- [PreRecCam](#prereccam)
- [10000 Hours - Time Tracker](#10000_hours_-_time_tracker)
- [熊猫吃短信 - 旧版](#熊猫吃短信_-_旧版)
- [Merge Watermelon 4 Watch](#merge_watermelon_4_watch)
- [Watch Game Collection](#watch_game_collection)
- [Things 3](#things_3)
- [HAMQ](#hamq)
- [不折叠输入法](#不折叠输入法)
...
- [Merge Watermelon for watch](#merge_watermelon_for_watch)

#### camscanner___|_ocr_scanner
## CamScanner + | OCR Scanner
![CamScanner + | OCR Scanner](app_logos/388624839.png)
...
#### 同花顺至尊版-股票软件
## 同花顺至尊版-股票软件
![同花顺至尊版-股票软件](app_logos/954724812.png)
...
![BerryFilm - Korean Style Cam](app_logos/6741474933.png)
...
#### 墨墨记忆卡｜考研考公考证外语学习闪卡
## 墨墨记忆卡｜考研考公考证外语学习闪卡
![墨墨记忆卡｜考研考公考证外语学习闪卡](app_logos/1537782938.png)
...
## 航旅纵横PRO-民航官方直销平台值机火车票接送机免税酒店
![航旅纵横PRO-民航官方直销平台值机火车票接送机免税酒店](app_logos/768160271.png)
...
![AirBasketball - AuditoryAR](app_logos/1625289361.png)
...
![Alook Browser - 8x Speed](app_logos/1261944766.png)
...
![Forest: Focus for Productivity](app_logos/866450515.png)
...
![Countdown! Reminders and Timer](app_logos/1439723850.png)
...
#### 甜蛙_-_甜甜约会！！！
## 甜蛙 - 甜甜约会！！！
![甜蛙 - 甜甜约会！！！](app_logos/1095903651.png)
...
![AutoSleep Track Sleep on Watch](app_logos/1164801111.png)
...
#### 金十数据专业版-为交易而生
## 金十数据专业版-为交易而生
![金十数据专业版-为交易而生](app_logos/1197275827.png)
...
#### 遮挡壁纸_-_可遮挡锁屏管理文字壁纸
## 遮挡壁纸 - 可遮挡锁屏管理文字壁纸
![遮挡壁纸 - 可遮挡锁屏管理文字壁纸](app_logos/6739608248.png)

遮挡壁纸，为您提供丰富的锁屏及主屏幕个性化设置。

专业设计师精心设计和搭配的壁纸，完美适配您的手机，全新的视觉感受。

+ 遮挡壁纸：创意个性壁纸，可遮挡住锁屏上的【此iPhone受远程管理】文字！
+ DIY制作遮挡壁纸：内置丰富的壁纸模板及遮挡贴纸，或者可以从相册导入图片制作您自己喜欢的个性化遮挡壁纸

#### procreate_pocket
## Procreate Pocket
![Procreate Pocket](app_logos/916366645.png)
...
#### 古诗文网-唐诗宋词古文典籍
## 古诗文网-唐诗宋词古文典籍
![古诗文网-唐诗宋词古文典籍](app_logos/964708975.png)

【主要特色】
1、古诗文、古籍特别全，分类详细
2、注释翻译解析质量沉实，有拼音批注方便查看，还有朗读
3、内容权威，文献证明，内嵌字典，赏析到位
4、界面简洁清新很有代入感
5、功能实用快捷、浏览丝滑方便，分屏便捷，搜索迅速，引导合理
...
四大核心竞争力
最全文库：覆盖先秦至明清2万+作者作品
精准解析：附【创作背景】【文言语法】【典故溯源】三维解读
交互黑科技：分屏对照（原文/译文/注释/赏析/拼音自由组合）
零干扰体验：沉浸式阅读
...
1.服务名称：纯净模式/金紫会员永久
2.订阅周期：永久
3.若您从AppStore购买纯净模式/金紫会员永久，则为单次付费永久生效

三、其它单次付费说明
1.服务名称：下载次数
2.订阅周期：单次
3.若您从AppStore购买下载次数，则为单次付费单次生效

四、相关协议
1. 用户协议：https://app24.guwendao.net/agreementChunjingIOSGwd.aspx
2. 纯净模式服务协议：https://app24.guwendao.net/agreementChunjingIOSGwd.aspx
3.金紫会员服务协议（含其它单购项目）：https://app24.guwendao.net/agreementSvipIOSGwd.aspx
4.隐私协议：https://app24.guwendao.net/yinsiIosGwd.aspx

#### pewpewpew_-_fingergun
## PewPewPew - Fingergun
![PewPewPew - Fingergun](app_logos/6448477521.png)
...
![花皮 - 同城约会，无面具社交，解压释放正念素颜](app_logos/6740246950.png)
...
#### 随手记pro
## 随手记Pro
![随手记Pro](app_logos/373454750.png)
...
#### atvtools
## atvTools
![atvTools](app_logos/1661419573.png)
...
![Peggy Cat - A Virtual Pet](app_logos/1578203914.png)
...
![SnapKoin: Fast Expense Tracker](app_logos/6742044212.png)
...
#### 同城约友-梦幻沉浸式交友新体验
## 同城约友-梦幻沉浸式交友新体验
![同城约友-梦幻沉浸式交友新体验](app_logos/6738114005.png)
...
![Daily Dozen-Culture in Photos](app_logos/807317212.png)
...
#### 东方财富领先版-财经资讯_股票开户
## 东方财富领先版-财经资讯&股票开户
![东方财富领先版-财经资讯&股票开户](app_logos/530425820.png)
...
#### phet_simulations
## PhET Simulations
![PhET Simulations](app_logos/1134126831.png)
...
#### 完蛋！我被美女包围了！
## 完蛋！我被美女包围了！
![完蛋！我被美女包围了！](app_logos/6499125531.png)
...
![Kino - Pro Video Camera](app_logos/6472380172.png)
...
#### 飞常准pro-全球航班查询机票酒店预订
## 飞常准PRO-全球航班查询机票酒店预订
![飞常准PRO-全球航班查询机票酒店预订](app_logos/469338840.png)
...
#### 每日英语阅读
## 每日英语阅读
![每日英语阅读](app_logos/1464850921.png)
...
#### rakugakiar
## RakugakiAR
![RakugakiAR](app_logos/1515215584.png)
...
#### 手表浏览器
## 手表浏览器
![手表浏览器](app_logos/1603553413.png)
...
#### 凤凰新闻(专业版)-头条新闻阅读平台
## 凤凰新闻(专业版)-头条新闻阅读平台
![凤凰新闻(专业版)-头条新闻阅读平台](app_logos/1152396902.png)
...
#### procam_-_pro_camera
## ProCam - Pro Camera
![ProCam - Pro Camera](app_logos/730712409.png)
...
#### 隐形守护者
## 隐形守护者
![隐形守护者](app_logos/1459076631.png)
...
## Sudoku Clean - No ads
![Sudoku Clean - No ads](app_logos/6739777600.png)
...
#### clashx_pro_-_server_manager
## ClashX Pro - Server Manager
![ClashX Pro - Server Manager](app_logos/6749874545.png)

A simple and easy-to-use Clash controller management app that supports multiple Clash cores and OpenWrt systems, offering intuitive server management and proxy configuration features.
...
- Multiple server support: Manage multiple Clash controllers at the same time
- Server status monitoring: Display server connection status and version information in real time
- Quick add: Supports both Clash Controller and OpenWrt server types
- Server configuration editing: Modify server parameters and connection settings


Proxy Management

- Proxy group management: View and manage all proxy groups
- Node switching: Quickly switch nodes within a proxy group
- Latency testing: Test node latency and display results
- Global mode switching: Supports Global, Rule, and Direct modes


Network Monitoring

- Real-time speed monitoring: Display upload and download speeds
- Network status detection: Monitor network connection status


Configuration Management

- Configuration file editing: Edit Clash configuration files online
- Configuration list management: View and manage multiple configuration files
- Subscription info display: Show remaining traffic and expiration date of subscriptions


User Experience

- Multi-theme support: Light mode, dark mode, and eye-care mode
- Multi-language support: Chinese and English interfaces
- Responsive design: Adapted for different screen sizes
- Custom settings: Configurable options such as request timeout and status check intervals

#### iguzheng
## iGuzheng
![iGuzheng](app_logos/519411018.png)
...
#### list背单词
## List背单词
![List背单词](app_logos/1459749978.png)
...
#### 新概念英语专业版_-_英语美语全四册
## 新概念英语专业版 - 英语美语全四册
![新概念英语专业版 - 英语美语全四册](app_logos/755018884.png)
...
#### manyue
## ManYue
![ManYue](app_logos/6753895889.png)
...
#### 心岛日记-难过的人不孤独
## 心岛日记-难过的人不孤独
![心岛日记-难过的人不孤独](app_logos/1530149693.png)
...
#### 每日英语_听力学习版
## 每日英语 听力学习版
![每日英语 听力学习版](app_logos/1476509317.png)
...
![Good Maps - for Google Maps, with Offline Map, Directions, Street Views and More](app_logos/657016140.png)
...
#### 轻历_-_清新日历
## 轻历 - 清新日历
![轻历 - 清新日历](app_logos/1513506417.png)
...
![HeartWatch: Heart Rate Monitor](app_logos/1062745479.png)
...
![CatLight Pro: Selfie Light Cam](app_logos/6737987084.png)
...
#### xp3player
## XP3Player
![XP3Player](app_logos/1064060287.png)
...
![NetTV: Watch Global TV](app_logos/6738272916.png)
...
![AnkiMobile Flashcards](app_logos/373493387.png)
...
![Planit Pro: Photo Planner](app_logos/898876435.png)
...
#### 法语背单词_-_法语单词记忆工具
## 法语背单词 - 法语单词记忆工具
![法语背单词 - 法语单词记忆工具](app_logos/998437582.png)
...
#### voidlink
## VoidLink
![VoidLink](app_logos/6747717070.png)
...
## Spark - Ren'Py Novels
![Spark - Ren'Py Novels](app_logos/6474479684.png)
...
#### colorburn
## Colorburn
![Colorburn](app_logos/899003026.png)
...
#### lemon_tv
## Lemon TV
![Lemon TV](app_logos/6745812361.png)

Lemon TV is a full-featured remote control for Media Center. 
It features library browsing, now playing informations and a direct remote control.
======================================================
Control volume,Browse, search and sort your library,Access your favorites, Live view of currently playing playlist,Displays music cover art where available,Displays movie poster and actor thumbs where available,Displays details for albums, artists, movies, TV shows and more,Play and queue albums, songs, movies, genre selections and much more,Switch to live TV channels and trigger or play recordings on your PVR 


Automatic renewal
--Content: Friendship support.
--Subscription period: 1 year (members receive annual product subscriptions).
--Subscription price: Based on iAP application information, for example, $9.99 per year for continuous annual product packages.
--Payment: After the user confirms the purchase and makes the payment, it will be credited to their iTunes account.
--Cancel Renewal: To cancel the renewal, please manually turn off the automatic renewal feature in iTunes/Apple ID settings management 24 hours before the current subscription period expires.
--Renewal: The Apple iTunes account will be charged within 24 hours before expiration, and once the charge is successful, the subscription period will be extended by one subscription period.
--Privacy Policy: https://www.netlify.com/privacy/
--User Agreement: https://www.netlify.com/privacy/
--Membership Service Agreement: https://docs.qq.com/doc/DVXRZVEVWTG9LeW9p
--Automatic Renewal Service Agreement: https://docs.qq.com/doc/DVUJiR25wcUZWaFht

#### 鲨鱼记账本pro-管家理财必备工具
## 鲨鱼记账本Pro-管家理财必备工具
![鲨鱼记账本Pro-管家理财必备工具](app_logos/1163515895.png)
...
#### kirakira_
## kirakira+
![kirakira+](app_logos/955687901.png)
...
#### analog_paris
## Analog Paris
![Analog Paris](app_logos/1035219562.png)
...
#### sleeptown
## SleepTown
![SleepTown](app_logos/1210251567.png)
...
#### workoutdoors
## WorkOutDoors
![WorkOutDoors](app_logos/1241909999.png)
...
#### 我爱截图_-_微商营销做图工具
## 我爱截图 - 微商营销做图工具
![我爱截图 - 微商营销做图工具](app_logos/1547424687.png)

一款专业的微商截图软件，让您做微商更简单
无水印所有功能直接使用！
微商日记本：微商经营心得随心记
微商客源：搜索众多行业的客源数据，让营销更简单
截图拼接：N张截图拼接为一张长图发朋友圈更有力
网页抓图：抓图众多网页图片更方便
截图编辑：让图片编辑更简单

#### d2_pal_pro_for_diablo2
## D2 Pal Pro for Diablo2
![D2 Pal Pro for Diablo2](app_logos/1562555975.png)

『 Functions 』

-【Database】Check out and search items.

-【simulator】 skills and build simulators, and regularly updated and recommended to facilitate new and old players!

-【News】Browse latest news of D2R.

Stay tuned for more features!

D2 Pal - Game fans' best choice!

#### 怦然心动的瞬间-轻科幻真人互动恋爱影游
## 怦然心动的瞬间-轻科幻真人互动恋爱影游
![怦然心动的瞬间-轻科幻真人互动恋爱影游](app_logos/6737512463.png)
...
#### 女帝的日常
## 女帝的日常
![女帝的日常](app_logos/1576763082.png)
...
#### nplayer
## nPlayer
![nPlayer](app_logos/1116905928.png)
...
#### dotink
## DotInk
![DotInk](app_logos/6754073002.png)
...
#### promovie_recorder__
## ProMovie Recorder +
![ProMovie Recorder +](app_logos/1184204602.png)
...
•  High-quality video recording with up to 224Mbps bitrate.
...
¹
4K @30FPS: iPhone 6s/6s Plus/SE and newer, iPad (2022), iPad Mini (2021 and newer), iPad Air (2020 and newer), iPad Pro 9.7-in., iPad Pro 10.5-in., iPad Pro 12.9-in. (2017 and newer), iPad Pro 11-in. (all models), iPad Pro 13-in.
4K @60FPS: iPhone 8/8 Plus/X and newer, iPad (2022), iPad Mini (2021 and newer), iPad Air (2020 and newer), iPad Pro 12.9-in. (2018 and newer), iPad Pro 11-in. (all models), iPad Pro 13-in.
4K @120FPS: iPhone 16 Pro/16 Pro Max.

²
1080p @30FPS: iPhone 5s and newer, iPad (2017 and newer), iPad Mini (2013 and newer), iPad Air (all models), iPad Pro (all models).
1080p @60FPS: iPhone 6/6 Plus/SE and newer, iPad (2022), iPad Mini (2021 and newer), iPad Air (2020 and newer), iPad Pro 9.7-in., iPad Pro 10.5-in., iPad Pro 12.9-in. (2017 and newer), iPad Pro 11-in. (all models), iPad Pro 13-in.
1080p @120FPS: iPhone 6s/6s Plus/SE and newer, iPad (2022), iPad Mini (2021 and newer), iPad Air (2020 and newer), iPad Pro 9.7-in., iPad Pro 10.5-in., iPad Pro 12.9-in. (2017 and newer), iPad Pro 11-in. (all models), iPad Pro 13-in.
1080p @240FPS: iPhone 8/8 Plus/X and newer, iPad (2022), iPad Mini (2021 and newer), iPad Air (2020 and newer), iPad Pro 12.9-in. (2018 and newer), iPad Pro 11-in. (all models), iPad Pro 13-in.
...
![CNC Lathe calculator](app_logos/1485500283.png)
...
#### plant_a_day
## Plant a Day
![Plant a Day](app_logos/6749935288.png)

Daily Updates: A beautifully designed card introducing plant features, habits, and fun facts

Bite-Sized Knowledge: Learn in just 1 minute

Beautiful Images: HD photos showcasing the beauty of plants

Expand Your World: Discover plants from all over the globe

Whether you’re a plant lover, a nature enthusiast, or simply looking to add a little curiosity to your day, Plant a Day will bring you fresh discoveries.
Download now and start your daily plant journey!

#### human_anatomy_atlas_2026
## Human Anatomy Atlas 2026
![Human Anatomy Atlas 2026](app_logos/1117998129.png)
...
#### jpics
## JPics
![JPics](app_logos/961328776.png)

JPics focuses on long image stitching. Support splicing photos taken by SLR, original picture quality output; support full webpage screenshots.

Applicable scenarios: Seamless stitching of chat records, movie lines, web page screenshots, life photos, screenshots, learning materials, landscapes, long Weibo, etc.

【Features】
-Super clear preservation, original picture quality output;
-The page is concise, focusing on long image stitching, no ads, no in-app purchases;
-Stitch up to 24 pictures;
-Support manual stitching to cover overlapping parts of pictures;
-Support vertical and horizontal stitching of pictures;
-Support picture cut, graffiti, add text;
-Support setting border color and gap;
-Support border style setting (preview page, click "border" in the lower left corner);
-Support full webpage screenshot (two ways to use: 1. Open JPics plugin in safari browser; 2. Copy webpage link and start JPics);
-Support system photo album plugin, you can directly stitch long images in the system photo album without opening the App, at most 10 pictures at a time (usage: open the album> select multiple pictures> select the share button in the lower left corner> "more" activity > Open "JPics")
-Support custom splicing template. Create custom templates such as movie lines and chat records, and automatically stitch long pictures with one click.

#### tampermonkey
## Tampermonkey
![Tampermonkey](app_logos/6738342400.png)
...
#### camera360_concept_-_hellocamera
## Camera360 Concept - HelloCamera
![Camera360 Concept - HelloCamera](app_logos/545623778.png)

· Work by Famous Mobile Photography Provider Camera360
· Paid App for Photography with the Most Downloads in China and Thailand


Hello Camera is a camera APP developed by Camera360 group. As a concept application for future camera, it starts a revolution in phone photo photography. With ‘Portrait’, ‘Scenery’, ‘Food’, ‘Night’, ‘Still Objects’, Hello Camera provides different photographing themes to you. Select the proper photographing theme for your photo and Hello Camera will choose matched Filters for your photo automatically. Hello Camera can help you to capture every wonderful moment easily and it owns the view that is clearer, richer gradation, and more charming.

Development Team
Hello Camera is developed by Chengdu Pinguo Technology Ltd., which focuses on researching and developing high technology products on mobile image and service for phone. It owns such popular applications as Camera360 and Movie360. With great filters, UI, UE and so on, its products are leading a fashion of phone photography but Pinguo is always trying to be better and better. 
...
#### prereccam
## PreRecCam
![PreRecCam](app_logos/6744694923.png)
...
#### 10000_hours_-_time_tracker
## 10000 Hours - Time Tracker
![10000 Hours - Time Tracker](app_logos/6503428826.png)

You've probably heard of the "10,000 Hours" theory, and you might have been intimidated by the daunting prospect of it. But the truth is, all you need to do is start. The first second you begin holds significance.

I developed the "10000 Hours" timer app with the hope of bringing a little bit of light to the chaotic, out-of-control, and seemingly meaningless situations. Create your life project and nurture it every day with time. Enjoy the peace and satisfaction of every second slipping through your fingers. Will it bloom and bear fruit? Most likely, it will. And if it doesn't? Enjoy the mindful process, explore, and understand yourself a bit more; that in itself is a blessing.

What can you do with "10000 Hours"?

1. Create and time your life projects daily: It could be a subject for students, a hobby for workers, a small thing you want to try, or a tiny habit you want to develop. Believe in the power of time, change starts at every moment.

2. View project data and charts: Review your project check-in habits and time investment.

3. Manage all projects: Archive completed projects and reopen projects that need continuation.

4. iCloud automatic synchronization of project data: Easily continue even if you reinstall the app or change devices.

If you have any comments or suggestions during the use of the product, please feel free to email us. We are always delighted with your feedback! 
mailto:zjy0314@icloud.com

----------------------

We do not collect any of your personal privacy. For the privacy policy, visit: https://zjymm0314.notion.site/d98112944f644ca18554b560bb0bf5f7?pvs=4

#### 熊猫吃短信_-_旧版
## 熊猫吃短信 - 旧版
![熊猫吃短信 - 旧版](app_logos/1319191852.png)
...
![Merge Watermelon 4 Watch](app_logos/6449766387.png)
...
#### watch_game_collection
## Watch Game Collection
![Watch Game Collection](app_logos/6742131931.png)

Transform your watch into a pocket arcade! 

Featured Games:
• Orbit Defense: A unique orbital defense game testing your reflexes
• Lights Out: Brain-teasing puzzle with minimal moves challenge
• Jump Dinosaur: Agile little dinosaur, leaping over obstacles for miles, testing your speed and courage
• Color Trek: Tap the screen to move the ball forward, rotate the crown to adjust up and down, maneuver skillfully, dodge obstacles, and reach the goal!
• Merge Planet: Fun stress relief, merge into a giant planet  
• Dice Roller: Shake for luck, anytime, anywhere
• Tic Tac Toe: Strategic battles against smart AI
• Brick Breaker: Classic arcade action at your fingertips
• Pixel Bird: Tap the screen, soar through the sky, and test your reflexes!
• Star Elimination: Link the stars, light up the sky, blast away!
• Memory Match: Tap to flip, match to win, challenge your mind!
• Snake: Control the snake, eat the food, challenge the limits, and become the ultimate snake king!
• Space War: Control the spacecraft, battle alien enemies, and become a hero of the universe!
• Whack a Mole：Lightning-fast reflexes! Smash those moles! Feel the thrill of the hammer!‌
• Bridge Hero：‌Steady aim, steady hands! Build sky-high bridges! Conquer extreme distances!‌
• Thread the Needle：Swift eyes, precise moves! Thread the needle perfectly! Break through the impossible gaps!‌
• Tetris：Stack with strategy! Clear full lines! Master speed & spatial mastery!‌
• Connect Match：Clever connections! Match identical tiles! Push your matching skills to the limit!‌
• Electronic Wooden Fish：Tap the Mokugyo. Accumulate karma. Find instant zen.‌
• Number Puzzle: Slide the number tiles into order — a fun test of logic and patience!
• Minesweeper: Smart deduction, avoid mines, reveal safe tiles, and challenge your limits!
• Fish Tank Dash: Quick reflexes, dodge the fish bones, grab the lively fish, and chase the ultimate high score!
• Pixel Racing: Speed through traffic, dodge dangers, collect coins, and chase the ultimate street legend!
• Water Sort: Pour with wisdom, sort the vibrant colors, fill each tube, and become a logic puzzle master!
• Ball Sort: Tap to move, match colors, fill the tubes, and challenge your logic to the limit!
• Stack Blocks: Stack your blocks layer by layer and challenge the ultimate height!
• 2048: The addictive number-merging puzzle reimagined

Highlights:
• Optimized touch controls
• Perfect for watch display
• High score tracking
• Regular game updates
• No internet required

When to play? Anytime, anywhere, endless fun!

• While waiting for the bus or people — No more boredom!
On the bus, subway, or in line, grab a game and the time flies by!

• During meeting breaks, relax a bit — Take a moment to refresh and boost productivity!

• While waiting for food, no more boredom!
Waiting for your meal? Why not challenge yourself with a fun game!

• Relax before bed, a sleep aid!
Play a quick game before bed to unwind and sleep better!

• Toilet time entertainment, a fun break!
Make every bathroom break a little more entertaining!

• In your spare time, play anytime!
On the elevator, during lunch break, between classes, or during a gym rest — anytime is game time!

• In the passenger seat, making the journey fun!
On long road trips or waiting for others in the car, let the game make the time fly!

• At a party, time to show your skills!
Challenge your friends and see who is the true gaming champion!

No matter when or where, just lift your watch and start playing. Fun is always at your fingertips! 

More exciting games coming soon! Turn your watch into more than just a timepiece - make it your personal gaming companion!

#### things_3
## Things 3
![Things 3](app_logos/904237743.png)
...
#### hamq
## HAMQ
![HAMQ](app_logos/6754198942.png)

[Accurate Prediction, Locking on to Transiting Satellites]
Based on the professional SGP4 algorithm, satellite orbits and transit times are calculated in real time. Clear azimuth, elevation, and pointing guidance is provided for both LEO and GEO satellites, allowing you to easily establish satellite connections.

[AI Recognition, Automatic Call Log Transfer]
Innovatively integrated AI voice recognition technology! With a single click, recording automatically extracts key information like callsign and QTH, generating a standard contact log for you, completely hands-free.

[Essential Exam Prep, Continuously Updated Question Bank]
Contains the latest question banks for Amateur Radio Class A/B/C certifications, along with practice exams and question-review tools to help you efficiently review and successfully obtain your certification.

[Professional Management, Clear and Organized Records]
A powerful log management system supports Maidenhead grid positioning. All contact records and voice logs are quickly searchable, helping you become a more professional HAM.

#### 不折叠输入法
## 不折叠输入法
![不折叠输入法](app_logos/1464555198.png)

Scenarios for folding input for third-party applications, such as

1. Publishing long text in a circle of friends will be folded into one line.

2. The mood of a diary written in advance is easily ignored by friends.

Encourage original content and create a good square atmosphere together.

characteristic

1. Interaction is simple and easy to use.

2. Intelligent input speed control

3. Text intelligent transfer, let you of the document is different

Join QQ Group 767609209 and communicate with the author

————————

【Explanation for Pro Edition】

Subscription cycle: 1 month (continuous package)

Subscription Price: Continuous monthly package product is $0.49 per month

The iTunes account will be deducted after payment is confirmed or after the free probation period (if any). Subscriptions will be automatically renewed unless the automatic renewal function is turned off 24 hours before the current subscription. Apple's iTunes account will deduct fees within 24 hours of maturity, and the subscription cycle will be extended by one subscription cycle after successful deduction.

Privacy Policy
https://www.freeprivacypolicy.com/privacy/view/9ade4ba28df2cfefe91bfb8b92f2e662

Terms of Use
https://mp.weixin.qq.com/s/nupj_u83nSfwIe0mFNjsQA

#### renpyreader
## RenpyReader
![RenpyReader](app_logos/6479896772.png)
...
#### 某某宗女修修炼手札
## 某某宗女修修炼手札
![某某宗女修修炼手札](app_logos/1509817154.png)
...
#### list_habits
## List Habits
![List Habits](app_logos/1641084877.png)

List Habits, is a lightweight, minimalist punch card, record life, develop good habits software.

Read books, memorize words, study for exams, take exams, get certified, exercise, lose weight, work out, gain muscle, go to bed early, wake up early, keep accounts, save money and other life points, insist on daily punching, develop good habits and record your growth every step of the way.

Features:
- Support the creation of an unlimited number of habits.
- Using different colors and icons to distinguish various types of habits.
- support for adjusting habits and their order.
- support to hide or show habits.
- support for setting the start of each week.
- dark/light appearance with free switching.
- tracking of the various records of the habits.
- simple and clear weekly, monthly and yearly clocking statistics.
- widget feature, support displaying today/this week/this month punching status for each habit.
- widget feature, supports displaying up to 7 habits' punching status for the week at the same time.
- iCloud data auto-sync, seamless switching between multiple devices.

If you have any questions about using it, please contact shawn736_ios@163.com.

#### merge_watermelon_for_watch
## Merge Watermelon for watch
![Merge Watermelon for watch](app_logos/1556671822.png)

Big Watermelon is a casual puzzle game.
You can swipe the fruit with your fingers to combine two identical fruits into a larger fruit. The more fruits you synthesize, the more points you get.
Use your space imagination to synthesize more big watermelons!
